...
public class Utils {
    ...
    public static final String PIZZA_1_DESCRIPRON = "Forget takeaways – you can’t beat a homemade Margherita pizza topped with fresh tomato sauce and melted cheese. Here's how to master this everyday classic.....";
    public static final String PIZZA_2_DESCRIPRON = "Even a novice cook can master the art of pizza with our simple step-by-step guide. Bellissimo";
    public static final String PIZZA_3_DESCRIPRON = "Make a veggie pizza that's healthy and low-fat instead of ordering a takeaway. This easy recipe uses goat's cheese for tang while the onions give it sweetness...";
    public static final String PIZZA_4_DESCRIPRON = "The quantities for this are generous, so if you have any leftovers, pop a wedge of cold pizza into your lunchbox the next day";
    public static final String PIZZA_5_DESCRIPRON = "Not good for you? Think again, this easy to make pizza is low fat and full of calcium";
